...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const artists = {
        'Louis Armstrong': [
        { title: "Louis Armstrong - What A Wonderful World", src: "msc/jazz/louis/Louis Armstrong - What A Wonderful World (At The BBC).mp3", duration: "2:19", album: "What a Wonderful World (1967)" }
    ],

    'Frank Sinatra': [
        { title: "Frank Sinatra - My Way ", src: "msc/jazz/frank/Frank Sinatra - My Way (Live At Madison Square Garden, New York City _ 1974 _ 2019 Edit).mp3", duration: "4:35", album: "My Way (1969)" }
    ],

    'John Coltrane': [
        {title: "In A Sentimental Mood", src: "msc/jazz/john/In A Sentimental Mood.mp3", duration: "4:16", album: "Duke Ellington & John Coltrane (1963)"}
    ],

    'Al Jarreau': [
        {title: "Al Jarreau - Mornin", src: "msc/jazz/aljarreu/Al Jarreau - Mornin' (Official Video).mp3", duration: "4:16", album: "Jarreau (1983)"}
    ],

    'Ray Charles': [
        { title: "Ray Charles - Georgia On My Mind", src: "msc/jazz/ray/Ray Charles - Georgia On My Mind (Official Video).mp3", duration: "3:38", album: "The Genius Hits the Road (1960)" }
    ],
    'Carmen McRae': [
        { title: "Carmen McRae - Take Five", src: "msc/jazz/carmem/Carmen McRae - Take Five.mp3", duration: "4:40", album: "Take Five Live (1961)" }
    ],
    'Big Joe Turner': [
        { title: "Shake, Rattle and Roll", src: "msc/jazz/bigjoe/Shake, Rattle and Roll.mp3", duration: "2:59", album: "Rock & Roll (1957)" }
    ],
    'Billie Holiday': [
        { title: "Billie Holiday - I'll Be Seeing You", src: "msc/jazz/bilieholie/Billie Holiday - _i´ll be seeing you_.mp3", duration: "3:32", album: "The Complete Billie Holiday on Verve (1944–1959)" }
    ]
