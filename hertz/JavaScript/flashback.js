...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const artists = {
    'Marvin Berry': [
{ title: "Earth Angel - Marvin Berry & The Starlighters", src: "msc/flashback/marvin/Earth Angel - Marvin Berry & The Starlighters (HQ).mp3", duration: "2:55", album: "Back to the 50's (Fictional Album)" }
],

    'Toto': [
    { title: "Toto - Hold The Line", src: "msc/flashback/toto/Toto - Hold The Line (Official Video).mp3", duration: "3:56", album: "Toto (1978)" }
],

    'Boston': [
    { title: "Boston - More Than a Feeling", src: "msc/flashback/boston/Boston - More Than a Feeling (Official Audio).mp3", duration: "4:45", album: "Boston (1976)" }
],

    'Bryan Adams': [
    { title: "Bryan Adams - (Everything I Do) I Do It For You", src: "msc/flashback/bryanadams/Bryan Adams - (Everything I Do) I Do It For You.mp3", duration: "6:35", album: "Waking Up the Neighbours (1991)" }
    ],

    'Europe': [
    { title: "Europe - The Final Countdown", src: "msc/flashback/europe/Europe - The Final Countdown (Official Video).mp3", duration: "5:10", album: "The Final Countdown (1986)" }
],

    'Petra': [
    { title: "Petra - Creed", src: "msc/flashback/petra/Petra - Creed.mp3", duration: "3:22", album: "Petra Praise 2: We Need Jesus (1997)" }
],

    'Paul Young': [
    { title: "Paul Young - Love of the Common People", src: "msc/flashback/paulyoung/Paul Young - Love of the Common People (Official Video).mp3", duration: "3:44", album: "The Secret of Association (1985)" }
],

    'Air Supply': [
    { title: "Air Supply - Making Love Out of Nothing at All", src: "msc/flashback/airsupply/Air Supply - Making Love Out Of Nothing At All (Official HD Video).mp3", duration: "5:38", album: "Greatest Hits (1983)" }
]
